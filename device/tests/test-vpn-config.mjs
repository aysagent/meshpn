...
static bool auth=true,save_fail=false;
...
static esp_err_t error(httpd_req_t*r,const char*s,const char*m){(void)r;(void)s;(void)m;return ESP_FAIL;}
...
esp_err_t meshvpn_vpn_start(const meshvpn_vpn_config_t*c){assert(c->enabled==saved.enabled);applies++;return ESP_OK;}
