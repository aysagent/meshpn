...
`MeshPN_XXXXXX`, WPA2 test password `meshpn-test`, normally 192.168.4.1/24. Admin is available on USB and the device's own AP, but not on the upstream STA network.
