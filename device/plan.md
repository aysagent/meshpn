...
Актуализировано 2026-09-09. Улучшения реализованы и проходят программные проверки; аппаратная приёмка остаётся открытой, поэтому задачи ниже не помечены полностью завершёнными.
