...
Следующий шаг — DNS privacy/explicit-loopback стенд, затем отдельное решение о
системной интеграции. Случайные cover DNS запросы не входят в этот план реализации.
